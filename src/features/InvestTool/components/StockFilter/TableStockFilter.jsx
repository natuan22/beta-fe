...
const TableStockFilter = ({ arrSliderCheckbox }) => {
    ...
    return (
        <div>
            <div className='pt-3'>
                <div className="flex justify-around items-center rounded-full mb-3 w-[800px]">
                ...
                <RenderTableStockFilter arrSliderCheckbox={arrSliderCheckbox} data={data} activeButton={activeButton} />
            </div>
        </div>
    )
}
