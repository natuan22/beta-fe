                        ...
                        <div className='grid grid-cols-4 gap-2'>
                            ...
                            >
                                <Button className='bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                        <path d="M1.00879 13.6759V12.8524C1.00879 9.6688 3.33429 7.08797 6.20295 7.08797" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                        ...
                                        <path d="M10.9248 11.2055L11.7344 12.1038L13.3533 10.3071" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6.20295 7.08797C7.84215 7.08797 9.17104 5.61317 9.17104 3.79398C9.17104 1.97477 7.84215 0.5 6.20295 0.5C4.56372 0.5 3.23486 1.97477 3.23486 3.79398C3.23486 5.61317 4.56372 7.08797 6.20295 7.08797Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                            ...
                            >
                                <Button className='bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                        ...
                                        <path d="M10.683 15.5V10.5C10.683 9.57951 9.99747 8.83334 9.15178 8.83334H7.62056C6.7749 8.83334 6.08936 9.57951 6.08936 10.5V15.5" stroke="white" stroke-miterlimit="16" />
                                    </svg>
                            ...
                            >
                                <Button className='bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                        <path d="M13.5089 6.81579C13.5089 6.02632 12.6755 5.23684 11.0089 5.23684C10.757 5.23684 10.4714 5.23684 10.1757 5.23684C8.79504 5.23684 7.67554 4.17646 7.67554 2.86842V0.5" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M13.5088 15.5H16.0088V8.39476H13.5088V11.9474M13.5088 15.5V11.9474M13.5088 15.5H1.00879V12.3421L3.92546 9.97371L7.25879 11.9474L10.5921 9.97371L13.5088 11.9474" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M16.0089 6.81579C16.0089 2.07895 12.6755 2.07895 12.6755 2.07895C12.6755 2.07895 16.0089 2.47368 16.0089 0.5" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
