...
const StockFilter = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    exchange: selectedExchange
      .map((exchange) => hashTbExchange[exchange])
      .join(","),
    industry: selectedIndustry
      .map((industry) => hashTbIndustry[industry])
      .join(","),
  });

  useEffect(() => {
    if (formData.filter.length > 0) dispatch(fetchDataStockFilter(formData));
        ...
        <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <Button className="bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1">
                    ...
                    >
                      <path
                        d="M1.00879 13.6759V12.8524C1.00879 9.6688 3.33429 7.08797 6.20295 7.08797"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M11.2516 7.34614C11.7278 6.76582 12.5506 6.76582 13.0268 7.34614C13.2675 7.63947 13.6134 7.79849 13.9705 7.77996C14.677 7.74331 15.2588 8.38902 15.2258 9.17307C15.2091 9.56933 15.3524 9.95325 15.6167 10.2204C16.1396 10.7489 16.1396 11.662 15.6167 12.1905C15.3524 12.4577 15.2091 12.8416 15.2258 13.2378C15.2588 14.0219 14.677 14.6676 13.9705 14.631C13.6134 14.6124 13.2675 14.7714 13.0268 15.0648C12.5506 15.6451 11.7278 15.6451 11.2516 15.0648C11.0109 14.7714 10.6649 14.6124 10.3079 14.631C9.60141 14.6676 9.01959 14.0219 9.05261 13.2378C9.0693 12.8416 8.92602 12.4577 8.66171 12.1905C8.13881 11.662 8.13881 10.7489 8.66171 10.2204C8.92602 9.95325 9.0693 9.56933 9.05261 9.17307C9.01959 8.38902 9.60141 7.74331 10.3079 7.77996C10.6649 7.79849 11.0109 7.63947 11.2516 7.34614Z"
                        stroke="white"
                      />
                      <path
                        d="M10.9248 11.2055L11.7344 12.1038L13.3533 10.3071"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M6.20295 7.08797C7.84215 7.08797 9.17104 5.61317 9.17104 3.79398C9.17104 1.97477 7.84215 0.5 6.20295 0.5C4.56372 0.5 3.23486 1.97477 3.23486 3.79398C3.23486 5.61317 4.56372 7.08797 6.20295 7.08797Z"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                    ...
                    <span className="ml-2">
                      {openYourFilter ? (
                        ...
                        >
                          <path
                            d="M1.00879 1L6.50879 6.5L12.0088 1"
                            stroke="white"
                          />
                        </svg>
                      )}
                  ...
                  content={
                    <div className="bg-[#034460] text-white overflow-auto scrollbar-thin scrollbar-thumb-[#436FB5] dark:scrollbar-track-[#151924] scrollbar-track-transparent border text-center">
                      {Object.keys(hashTbExchange).map((exchange, index) => (
                        <label
                          key={index}
                          className="material-checkbox py-2 px-2 text-white"
                        >
                          <input
                            type="checkbox"
                            name="exchange"
                ...
                >
                  <Button className="bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1">
                    ...
                    >
                      <path
                        d="M15.0102 0.5H11.9541L12.3369 4.66667C12.3369 4.66667 13.1025 5.5 14.2509 5.5C15.0755 5.5 15.6369 5.07037 15.888 4.82808C15.9881 4.73152 16.0247 4.58409 16.0027 4.44051L15.4633 0.9178C15.4264 0.676708 15.2347 0.5 15.0102 0.5Z"
                        stroke="white"
                      />
                      <path
                        d="M11.954 0.5L12.3368 4.66667C12.3368 4.66667 11.5712 5.5 10.4228 5.5C9.2744 5.5 8.50879 4.66667 8.50879 4.66667V0.5H11.954Z"
                        stroke="white"
                      />
                      <path
                        d="M8.50871 0.5V4.66667C8.50871 4.66667 7.7431 5.5 6.59468 5.5C5.44627 5.5 4.68066 4.66667 4.68066 4.66667L5.06347 0.5H8.50871Z"
                        stroke="white"
                      />
                      <path
                        d="M5.06356 0.5H2.00746C1.78291 0.5 1.59127 0.676708 1.55435 0.9178L1.01494 4.44052C0.992961 4.58409 1.02958 4.73152 1.12964 4.82808C1.3807 5.07037 1.94214 5.5 2.76672 5.5C3.91513 5.5 4.68076 4.66667 4.68076 4.66667L5.06356 0.5Z"
                        stroke="white"
                      />
                      <path
                        d="M1.62354 5.5V13.8333C1.62354 14.7538 2.30908 15.5 3.15475 15.5H13.8733C14.719 15.5 15.4045 14.7538 15.4045 13.8333V5.5"
                        stroke="white"
                      />
                      <path
                        d="M10.683 15.5V10.5C10.683 9.57951 9.99747 8.83334 9.15178 8.83334H7.62056C6.7749 8.83334 6.08936 9.57951 6.08936 10.5V15.5"
                        stroke="white"
                        strokeMiterlimit="16"
                      />
                    </svg>
                ...
                >
                  <Button className="bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1">
                    ...
                    >
                      <path
                        d="M1.00879 15V1C1.00879 0.723858 1.23265 0.5 1.50879 0.5H15.5088C15.785 0.5 16.0088 0.723858 16.0088 1V15C16.0088 15.2762 15.785 15.5 15.5088 15.5H1.50879C1.23265 15.5 1.00879 15.2762 1.00879 15Z"
                        stroke="white"
                      />
                      <path
                        d="M11.0088 5.08333C10.438 4.5125 9.43271 4.11545 8.50879 4.09059M8.50879 4.09059C7.40954 4.06101 6.42546 4.55831 6.42546 5.91667C6.42546 8.41666 11.0088 7.16666 11.0088 9.66666C11.0088 11.0925 9.78896 11.7052 8.50879 11.6592M8.50879 4.09059V2.58333M6.00879 10.5C6.54586 11.2161 7.54446 11.6245 8.50879 11.6592M8.50879 11.6592V13.4167"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                    </svg>
                    <span className="text-white ml-1 font-bold text-[11px]">
                      {valueSampleFilter}
                    </span>
                    <span className="ml-1">
                      {openSampleFilter ? (
                ...
                >
                  <Button className="bg-[#2790BD] btnInfoFilter border-none items-center flex justify-evenly h-[41px] px-2 py-1">
                    ...
                    >
                      <path
                        d="M13.5089 6.81579C13.5089 6.02632 12.6755 5.23684 11.0089 5.23684C10.757 5.23684 10.4714 5.23684 10.1757 5.23684C8.79504 5.23684 7.67554 4.17646 7.67554 2.86842V0.5"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M13.5088 15.5H16.0088V8.39476H13.5088V11.9474M13.5088 15.5V11.9474M13.5088 15.5H1.00879V12.3421L3.92546 9.97371L7.25879 11.9474L10.5921 9.97371L13.5088 11.9474"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M16.0089 6.81579C16.0089 2.07895 12.6755 2.07895 12.6755 2.07895C12.6755 2.07895 16.0089 2.47368 16.0089 0.5"
                        stroke="white"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                    </svg>
                    <span className="text-white ml-1 font-bold text-[10px]">
          ...
          <div className="text-white grid md:grid-cols-12 sm:grid-cols-none gap-3 pt-3">
            <div className="md:col-span-4 sm:col-span-full">
              <div className="text-center border border-solid border-t-2 border-b-0 border-x-0 border-[#2790BD] bg-[#154162] p-1">
                Yếu tố cần lọc
              </div>
            ...
            {arrSliderInput.map((key, index) => {
              ...
              if (minMax && name) {
                return (
                  <div
                    key={index}
                    className="flex justify-between items-center my-1 mx-2"
                  >
