...
const ExportExcel = ({ filteredResults, selectedItems, selectParameters }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#ADE6F9] h-[31px] py-[11px] px-[18.5px] self-center ml-[1px] cursor-pointer flex w-fit border-[1.5px] border-[#2D4CEF] border-solid rounded-lg hover:bg-gradient-to-b from-[#FFFFFFCC] to-[#08AADD]">
