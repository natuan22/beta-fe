...
import "../../InvestTool/components/SignalWarning/styles/style-loading.css";
import AlertManagement from "../components/SignalWarning/components/AlertManagement";
import DialogSettingSignal from "../components/SignalWarning/components/DialogSettingSignal";
import SignalBoard from "../components/SignalWarning/components/SignalBoard";
import "../components/SignalWarning/styles/table-antd-custom.css";
import { specificKeys, specificKeysV2 } from "../components/SignalWarning/utils/hashTb";
import { stockGr } from "../components/SignalWarning/utils/stock-gr";
      ...
      <div className="container mx-auto md:w-[90%] lg:w-[90%] xl:w-[90%] 2xl:w-full pt-2 font-[Roboto]">
        ...
        <div className="w-full font-[Roboto]">
          {yourSignalWarnings?.length > 0 ? (
            <div>
              <div className="flex md:flex-row sm:flex-col xs:flex-col xxs:flex-col justify-end gap-8 mt-2">
                <DialogSettingSignal
                  type={0}
