...
export const fetchDataTableTransactionStatistics =
...
export const fetchDataBalanceSheet =
  (stock, order, type) => async (dispatch) => {
    try {
...
export const fetchDataTransactionData =
  (stock, from, to) => async (dispatch) => {
    try {
...
export const fetchDataTradingPriceFluctuations =
  (stock) => async (dispatch) => {
    try {
...
export const fetchDataTableStatementsCashFlows =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataChartStatementsCashFlows =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataTableBusinessReport =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataChartBusinessReport =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataTableBalanceSheet =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataChartBalanceSheet =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataChartPieBalanceSheet =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataTableFinancialIndicators =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataChartFinancialIndicators =
  (stock, order) => async (dispatch) => {
    try {
...
export const fetchDataFinancialHealthAnalysis =
  (stock) => async (dispatch, getState) => {
    try {
...
export const fetchDataIndividualInvestorBenefits =
  (stock) => async (dispatch) => {
    try {
