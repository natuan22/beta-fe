                ...
                <div>
                                ...
                                <tr>
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p className={`font-bold ${getColor(data.perChange)}`}>
                                                ...
                                                /(
                                                {data.perChange &&
                                                    data.perChange.toLocaleString("en-US", {
                                                        minimumFractionDigits: 2,
                                                        maximumFractionDigits: 2,
                                                    })}
                                                %)
                                    ...
                                    >
                                        ...
                                        <p className="lg:text-2xl md:text-base lg:leading-[70px] md:leading-10">
                                            {data.kldg &&
                                                data.kldg.toLocaleString("en-US", {
                                                    maximumFractionDigits: 2,
                                                })}
                                        </p>
                                    </td>
                                    ...
                                    >
                                        ...
                                        <p className="lg:text-2xl md:text-base lg:leading-[70px] md:leading-10">
                                            {data.vh &&
                                                (data.vh / 1000000000).toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2,
                                                })}
                                        </p>
                                    ...
                                    >
                                        ...
                                        <p className="lg:text-2xl md:text-base lg:leading-[70px] md:leading-10">
                                            {data.roae &&
                                                data.roae.toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2,
                                                })}
                                        </p>
                                    ...
                                    >
                                        ...
                                        <p className="lg:text-2xl md:text-base lg:leading-[70px] md:leading-10">
                                            {data.roaa &&
                                                data.roaa.toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2,
                                                })}
                                        </p>
                                ...
                                <tr>
                                    <td className="dark:text-white text-black p-3 text-center border border-[#34A3F3] border-solid font-bold">
                                        <p className={`${getColor(data.p_week)}`}>
                                            {data.p_week &&
                                                data.p_week.toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2,
                                                })}
                                            %
                                    ...
                                    <td className="dark:text-white text-black p-3 text-center border border-[#34A3F3] border-solid font-bold">
                                        <p className={`${getColor(data.p_month)}`}>
                                            {data.p_month &&
                                                data.p_month.toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2,
                                                })}
                                            %
                                    ...
                                    <td className="dark:text-white text-black p-3 text-center border border-[#34A3F3] border-solid font-bold">
                                        <p className={`${getColor(data.p_year)}`}>
                                            {data.p_year &&
                                                data.p_year.toLocaleString("en-US", {
                                                    minimumFractionDigits: 2,
                    ...
                    <div className="grid lg:grid-cols-12 md:grid-cols-none gap-3">
                        ...
                        <div className={`lg:col-span-4 md:col-span-full`}>
                            ...
                            <div
                                className={`${showFullSummary && countWords(dataInfoHeader?.summary) > 459
                                    ? "overflow-y-scroll h-[310px]"
                                    : ""
                                    }`}
                            >
                                <p
                                    className={`dark:text-white text-black text-justify pt-2 text-sm pr-[5px] ${showFullSummary ? "" : "line-clamp-15"
                                        }`}
                                >
