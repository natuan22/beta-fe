...
const BussinessAnalysis = ({ queryApi }) => {
    const { dataBussinessAnalysis, dataBussinessAnalysisStatus } = useSelector((state) => state.stock);
    ...
    if (dataBussinessAnalysisStatus === 400 || dataBussinessAnalysis.length === 0) {
        return (
            <>
                ...
                <div>
                    <div className="grid sm:grid-cols-2 xs:grid-cols-none items-center">
                        ...
                        <div className="dark:text-white text-black text-justify">
                            ...
                            doanh của cổ phiếu {queryApi.stock} {getTextColorRating(dataBussinessAnalysis.totalStar).text} với mức
                            điểm số <span
                                className={
