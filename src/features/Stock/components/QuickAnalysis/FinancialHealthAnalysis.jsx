...
const FinancialHealthAnalysis = ({ queryApi }) => {
    const { dataFinancialHealthAnalysis, dataFinancialHealthAnalysisStatus } = useSelector(state => state.stock)
    ...
    if (dataFinancialHealthAnalysisStatus === 400 || dataFinancialHealthAnalysis.length === 0) {
        return (
            <>
