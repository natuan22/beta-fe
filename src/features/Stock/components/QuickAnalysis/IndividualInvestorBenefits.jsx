...
const IndividualInvestorBenefits = ({ queryApi }) => {
    const { dataIndividualInvestorBenefits, dataIndividualInvestorBenefitsStatus } = useSelector(state => state.stock)
    ...
    if (dataIndividualInvestorBenefitsStatus === 400 || dataIndividualInvestorBenefits.length === 0) {
        return (
            <>
