    ...
    return (
        <div>
            ...
            <div className='grid xl:grid-cols-2 lg:grid-cols-none gap-3'>
                ...
                <div>
                    <div className='dark:text-white text-black font-semibold mb-2 text-center uppercase xl:mt-[212px] lg:mt-10'>Tổng nguồn vốn {Array.isArray(dataPieInfo) && dataPieInfo[2].date}: {Array.isArray(dataPieInfo) && (dataPieInfo[2].value / 1000000000).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} (tỷ đồng)</div>
