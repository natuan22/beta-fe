...
import ChartBalanceSheet from './BalanceSheet/ChartBalanceSheet';
import TableBalanceSheet from './BalanceSheet/TableBalanceSheet';

const BalanceSheet = ({ codeUrl }) => {
    ...
    return (
        <div className='container mx-auto'>
            <div className='mt-8'>
                ...
                {activeBtn === 0 ? (
                    <div>
                        <TableBalanceSheet queryApiBusinessFinance={queryApiBusinessFinance} />
                    </div>
                ) : (
                    <div>
                        <ChartBalanceSheet queryApiBusinessFinance={queryApiBusinessFinance} />
                    </div>
                )}
            </div>
        </div>
