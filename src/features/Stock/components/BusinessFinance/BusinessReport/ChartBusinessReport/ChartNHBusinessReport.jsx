...
const ChartNHBusinessReport = ({ queryApiBusinessFinance }) => {
    ...
    useEffect(() => {
        dispatch(fetchDataChartBusinessReport(queryApiBusinessFinance.stock, queryApiBusinessFinance.order))
...
export default ChartNHBusinessReport