...
const SlideCreditQuality = ({ data, labels, time }) => {
    const [Arr1, Arr2, Arr3, Arr4] = data
    const [Label1, Label2, Label3, Label4] = labels
    return (
        <div>
            <div className='p-8'>
                <div className='text-center dark:text-white text-black font-semibold p-3 text-lg'>Chất lượng tín dụng</div>
...
export default SlideCreditQuality