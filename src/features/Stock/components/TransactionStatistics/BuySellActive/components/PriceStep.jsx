...
const PriceStep = ({ data }) => {
  ...
  const options = {
    ...
    xAxis: {
      ...
      title: {
        text: "Nghìn VNĐ",
        style: { color: localStorage.getItem("color"), fontSize: "9px", fontWeight: "bold" },
      },
      labels: {
        style: {
          fontSize: "9px",
    ...
    yAxis: {
      ...
      min: 0,
      gridLineWidth: 0,
      labels: { style: { color: localStorage.getItem("color"), fontSize: "9px", fontWeight: "bold" } },
    },
    legend: {
      enabled: true,
      verticalAlign: "top",
      itemStyle: { color: localStorage.getItem("color"), fontWeight: "bold", fontSize: "11px" },
    },
    plotOptions: {
      series: {
      ...
      bar: {
        ...
        dataLabels: {
          ...
          style: {
            color: localStorage.getItem("color"),
            textOutline: `${localStorage.getItem("color") === "#fff" ? '1px' : '0px'} black`, // Viền đen
