...
import { getColorWithValueReference } from "../../../../../Chart/utils/utils";
  ...
  return (
    <div className="w-full">
      <div className="relative flex flex-col min-w-0 break-words bg-transparent w-full rounded">
        <div className="block w-[98%] overflow-y-scroll h-[653px] bg-transparent border-1 border-[#0050AD] border-solid border-collapse scrollbar-thin scrollbar-thumb-[#0050AD] dark:scrollbar-track-black scrollbar-track-transparent">
          <table className="bg-transparent border-collapse w-full xs:text-base xxs:text-[14px]">
            <thead
                  ...
                  <Tooltip
                    ...
                    title={
                      <div className="w-[300px] text-justify">
                        Khi cả dòng có tô màu xanh tức là lệnh Lớn Mua chủ động
                        (&gt;1 tỷ đồng/lệnh), tô dòng màu đỏ tức là lệnh Lớn Bán
                        chủ động (&gt;1 tỷ đồng/lệnh).
                      </div>
                    }
