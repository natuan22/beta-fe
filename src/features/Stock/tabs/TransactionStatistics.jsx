        ...
        <div className="mt-4">
          ...
          <div className="mt-8">
            <div className="lg:flex md:block justify-between items-center">
                ...
                {!isChart ? (
                  <span className="border-solid border-[#34A3F3] border-b-2 border-t-0 border-x-0">
                    ...
                    <Popover content={contentTotalMatchingVolume}>
                      <span
                        className="xs:ml-[12.4rem] xxs:ml-36 text-[#C3A9A9] cursor-pointer text-[22px]"
              ...
              <div
                className="flex md:flex-row sm:flex-col xs:flex-col xxs:flex-col justify-center items-center lg:mt-0 md:mt-3 sm:mt-3 xs:mt-3 xxs:mt-3 input"
                id="datePicker"
              >
                <div className="flex items-center">
                  <span className="dark:text-white text-black w-[67.16px]">
                    Từ ngày
                  </span>
                  <div className="ml-4">
                    <DatePicker
