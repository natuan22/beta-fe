    ...
    <section className="bg-blueGray-50 pt-1.5">
      <div className="w-full">
        <div className="relative flex flex-col min-w-0 break-words bg-transparent w-full rounded">
          <div className="block xxs:w-[295px] xs:w-[350px] sm:w-[400px] md:w-[670px] lg:w-[897px] xl:w-full scrollbar-thin scrollbar-thumb-[#0050AD] dark:scrollbar-track-[#151924] scrollbar-track-transparent overflow-x-scroll bg-transparent h-[367px]">
                      ...
                      <tr className="dark:hover:bg-gray-800 hover:bg-gray-300 duration-500">
                        ...
                        {item.values.map((value, index) => (
                          <td
                            ...
                            style={{ border: "1px solid white" }}
                          >
                            {value.net_xnk.toLocaleString("vi-VN", {
                              maximumFractionDigits: 2,
                            })}
                          </td>
                        ))}
