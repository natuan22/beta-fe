                            ...
                            >
                              <div>
                                <img
                                  src={item.img}
                                  alt={item.title}
                                  className="bg-cover bg-center sm:h-[400px] xxs:h-[300px] w-full"
                                />
                                <h3 className="dark:text-white text-black my-2">
                                  {item.title}
                                </h3>
                                <p className="dark:text-white text-black text-[0.9rem]">
                                  {item.sub_title}
                                </p>
                              </div>
                            </a>
                          ...
                          >
                            <div className="flex">
                              <img
                                src={item.img}
                                alt={item.title}
                                className="bg-cover bg-center w-[150px] h-[100px]"
                              />
                          ...
                          <div className="card-body flex w-[350px] h-[90px] m-1">
                            <div className="card-img">
                              <img
                                src={item.img}
                                alt={item.title}
                                className="bg-cover bg-center w-[150px] h-[95px]"
                              />
                            </div>
