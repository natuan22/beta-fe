          ...
          <NavLink
            className={(params) => {
              if (params.isActive) {
                ...
                return "buttonStyle no-underline text-white mx-1 font-bold w-[30%] text-center opacity-70";
              }
            }}
          ...
          <NavLink
            className={(params) => {
              if (params.isActive) {
                ...
                return "buttonStyle no-underline text-white mx-1 font-bold w-[30%] text-center opacity-70 !text-[11px]";
              }
            }}
