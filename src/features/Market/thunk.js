...
export const fecthDataTableThanhKhoan =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchChartTickerContribute =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataInvestorTransaction =
  (type, investorType) => async (dispatch) => {
    try {
...
export const fetchDataDoRongThiTruong =
  (exchange, type) => async (dispatch) => {
    try {
...
export const fetchDataIndustryCashFlow =
  (exchange, type) => async (dispatch) => {
    try {
...
export const fetchDataTopNetBuyIndustry =
  (exchange, type) => async (dispatch) => {
    try {
...
export const fetchDataCashFlowInvestor =
  (type, investorType, exchange) => async (dispatch) => {
    try {
...
export const fetchDataTableChangesPrice =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataTableLiquidityGrowth =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataChartLiquidityGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartChangesPrice =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartEquityGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartLiabilitiesGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataTableEquityGrowth =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataTableLiabilitiesGrowth =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataChartNetRevenueGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartGrossProfitGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartEBITDAGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartEPSGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartOperatingProfitGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartCashDividendGrowth =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartAveragePE =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartAveragePB =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataTableAveragePE =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataTableAveragePB =
  (exchange, industry) => async (dispatch) => {
    try {
...
export const fetchDataChartPayoutRatio =
  (exchange, order) => async (dispatch) => {
    try {
...
export const fetchDataChartCashPayoutRatio =
  (exchange, order) => async (dispatch) => {
    try {
...
export const fetchDataChartAssetTurnoverRatio =
  (exchange, order) => async (dispatch) => {
    try {
...
export const fetchDataTableAverageDebtRatio =
  (exchange, order) => async (dispatch) => {
    try {
...
export const fetchDataChartMiningProfitMargin =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartInterestCoverageRatio =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartAverageDebitIndustry =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataChartNetProfitMargin =
  (exchange, type, order) => async (dispatch) => {
    try {
...
export const fetchDataTableMiningProfitMargin =
  (exchange, order) => async (dispatch) => {
    try {
