...
export const fetchDataChartInterestCoverageRatio = (exchange, type, order) => async (dispatch) => {
    try {
        const res = await marketServices.fetchDataChartInterestCoverageRatio(exchange, type, order)
        dispatch({
