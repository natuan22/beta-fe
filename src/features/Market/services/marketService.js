...
export const marketServices = {
  ...
  fetchDataTableLiquidityGrowth: (exchange, industry) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-thanh-khoan-co-phieu",
      {
        params: {
          exchange,
          industry,
  ...
  fetchDataChartEquityGrowth: (exchange, type, order) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-von-chu-so-huu-nganh",
      {
        params: {
          exchange,
          type,
  ...
  fetchDataTableEquityGrowth: (exchange, industry) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-von-chu-so-co-phieu",
      {
        params: {
          exchange,
          industry,
  ...
  fetchDataTableLiabilitiesGrowth: (exchange, industry) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-no-phai-tra-co-phieu",
      {
        params: {
          exchange,
          industry,
  ...
  fetchDataChartNetRevenueGrowth: (exchange, type, order) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-doanh-thu-thuan-nganh",
      {
        params: {
          exchange,
          type,
  ...
  fetchDataChartGrossProfitGrowth: (exchange, type, order) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-loi-nhuan-gop-nganh",
      {
        params: {
          exchange,
          type,
  ...
  fetchDataChartOperatingProfitGrowth: (exchange, type, order) => {
    return https.get(
      "api/v1/market/hieu-suat-tang-truong-loi-nhuan-kinh-doanh-nganh",
      {
        params: {
          exchange,
          type,
  ...
  fetchDataChartMiningProfitMargin: (exchange, type, order) => {
    return https.get(
      "api/v1/finance-health/ty-suat-loi-nhuan-gop-bien-cac-nhom-nganh",
      {
        params: {
          exchange,
          type,
  ...
  fetchDataTableMiningProfitMargin: (exchange, order) => {
    return https.get(
      "api/v1/finance-health/ty-suat-loi-nhuan-cac-nhom-nganh-table",
      {
        params: {
          exchange,
          order,
