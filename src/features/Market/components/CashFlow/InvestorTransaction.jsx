                    ...
                    dataInvestorTransaction?.map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          <td className="text-center px-1.5 align-middle whitespace-nowrap p-3.5 font-semibold">
                            {(item.buyVol / 1000000).toLocaleString("vi-VN", {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </td>
                          <td className="text-center px-1.5 align-middle whitespace-nowrap p-3.5 font-semibold">
                            {(item.buyVal / 1000000000).toLocaleString(
                              "vi-VN",
                              {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
                          ...
                          <td className="text-center px-1.5 align-middle whitespace-nowrap p-3.5 font-semibold">
                            {" "}
                            {(item.sellVol / 1000000).toLocaleString("vi-VN", {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}{" "}
                          </td>
                          <td className="text-center px-1.5 align-middle whitespace-nowrap p-3.5 font-semibold">
                            {" "}
                            {(item.sellVal / 1000000000).toLocaleString(
                              "vi-VN",
                              {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2,
