                ...
                <span>
                    <button
                        ...
                        className={activeButton === 'all'
                            ...
                            : 'border-none bg-transparent dark:text-white text-black text-[1.1rem] cursor-pointer'}>Doanh nghiệp
                    </button>
                </span>
                <span className="pl-10">
                    <button
                        ...
                        className={activeButton === 'vimo'
                            ? 'border-none bg-transparent relative dark:text-white text-black text-[1.1rem] tabUnderline cursor-pointer'
                            : 'border-none bg-transparent dark:text-white text-black text-[1.1rem] cursor-pointer'}>Vĩ mô
                    </button>
                </span>
            </div>
