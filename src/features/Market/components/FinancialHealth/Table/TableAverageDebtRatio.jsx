    ...
    <section className="bg-blueGray-50 pt-1.5">
      <div className="w-full">
        <div className="relative flex flex-col min-w-0 break-words bg-transparent w-full rounded">
          <div className="block w-full scrollbar-thin scrollbar-thumb-[#0050AD] dark:scrollbar-track-[#151924] scrollbar-track-transparent overflow-y-scroll bg-transparent h-[335px]">
                ...
                {!loading ? (
                  ...
                  data.map((item, index) => {
                    return (
                      ...
                      >
                        <th
                          className={`text-left align-middle px-1 py-2.5 dark:text-white text-black md:text-base sm:text-sm xs:text-sm xxs:text-xs`}
                        >
                          {item.industry}
                        </th>
                        <td
                          className={`text-center align-middle px-1 py-2.5 dark:text-white text-black font-semibold md:text-base sm:text-sm xs:text-sm xxs:text-xs`}
                        >
                          {item.ICR.toLocaleString("vi-VN", {
                        ...
                        <td
                          className={`text-center align-middle px-1 py-2.5 dark:text-white text-black font-semibold md:text-base sm:text-sm xs:text-sm xxs:text-xs`}
                        >
                          {item.DSCR.toLocaleString("vi-VN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                        </td>
                        <td
                          className={`text-center align-middle px-1 py-2.5 dark:text-white text-black font-semibold md:text-base sm:text-sm xs:text-sm xxs:text-xs`}
                        >
                          {item.TDTA.toLocaleString("vi-VN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                        </td>
