...
{
  /* <div className="w-[80%] mx-auto p-2 bg-transparent  ">
<form className="flex flex-col items-center">
  ...
  <button className="text-white bg-blue-700 border-none hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    Đăng ký
  </button>
</form>
</div> */
