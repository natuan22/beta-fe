                ...
                <form className="otp-Form">
                    ...
                    <p className="resendNote">
                        ...
                        <button
                            ...
                            className={`${isResendDisabled ? 'cursor-not-allowed resendBtn bg-[#7f81ff] p-[10px] text-white font-bold text-sm border-0' : 'cursor-pointer resendBtn bg-[#7f81ff] p-[10px] text-white font-bold text-sm border-0  '}  `}
                            disabled={isResendDisabled}
                        >
                            {isResendDisabled ? `Gửi lại OTP sau:  ${countdown}s` : "Gửi lại OTP"}
                        </button>
                    </p>
                </form>
            </Modal>
