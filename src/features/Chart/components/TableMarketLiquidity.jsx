                  ...
                  {!loading ? (
                    ...
                    data?.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <th
                            className={`text-center align-middle xxs:text-[9px] text-sm whitespace-nowrap px-2 py-2 ${color}`}
                          >
                            {item.ticker}
                          </th>
                          <td
                            className={`text-center align-middle xxs:text-[9px] text-xs px-2 py-2 font-semibold ${color}`}
                          >
                            {item.industry}
                          </td>
                          <td
                            className={`text-center align-middle xxs:text-[9px] text-sm whitespace-nowrap px-2 py-2 font-semibold ${color}`}
                          >
                            {(item.value / 1000000000).toLocaleString("vi-VN", {
                          ...
                          <td
                            className={`text-center align-middle xxs:text-[9px] text-sm whitespace-nowrap px-2 py-2 font-semibold ${color}`}
                          >
                            {item.value_change_percent.toLocaleString("vi-VN", {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                            %
