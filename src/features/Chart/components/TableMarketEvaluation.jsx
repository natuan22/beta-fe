                  ...
                  <tr>
                    ...
                    {Array.isArray(data) &&
                      data?.map((item) => (
                        <th
                          key={item.Ticker}
                          className="text-center align-middle xxs:text-[6px] px-1 py-3 uppercase text-xs font-semibold text-white"
                        >
                          {item.Ticker}
                        </th>
                      ))}
                  ...
                  <tr className="dark:hover:bg-gray-800 hover:bg-gray-300 duration-500">
                    ...
                    {data?.map((item) => {
                      ...
                      return (
                        <td
                          key={item.Ticker}
                          className={`${color} text-center align-middle xxs:text-[6px] text-xs whitespace-nowrap px-1 py-2.5 font-semibold`}
                        >
                          {text}
                        </td>
                      );
