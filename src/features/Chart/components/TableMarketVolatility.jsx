...
const TableMarketVolatility = () => {
  const dataMarketVolatility = useSelector(
    (state) => state.chart.dataTableMarketVolatility
  );
                  ...
                  <tr>
                    ...
                    {Array.isArray(data) &&
                      data?.map((item) => (
                        <th
                          key={item.ticker}
                          className="text-center align-middle xxs:text-[7px] px-1 py-3 uppercase text-xs font-semibold text-white"
                        >
                          {item.ticker}
                        </th>
                      ))}
                  ...
                  <tr className="dark:hover:bg-gray-800 hover:bg-gray-300 duration-500">
                    ...
                    {data?.map((item) => {
                      ...
                      return (
                        <td
                          key={item.ticker}
                          className={`${color} text-center align-middle xxs:text-[7px] text-sm whitespace-nowrap px-1 py-2.5 font-semibold`}
                        >
                    ...
                    {data?.map((item) => {
                      ...
                      return (
                        <td
                          ...
                          className={`${color} text-center align-middle xxs:text-[7px] text-sm whitespace-nowrap px-1 py-2.5 font-semibold`}
                        >
                          {item.week_change_percent.toLocaleString("vi-VN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                          %
                    ...
                    {data?.map((item) => {
                      ...
                      return (
                        <td
                          ...
                          className={`${color} text-center align-middle xxs:text-[7px] text-sm whitespace-nowrap px-1 py-2.5 font-semibold`}
                        >
                          {item.month_change_percent.toLocaleString("vi-VN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                          %
                    ...
                    {data?.map((item) => {
                      ...
                      return (
                        <td
                          ...
                          className={`${color} text-center align-middle xxs:text-[7px] text-sm whitespace-nowrap px-1 py-2.5 font-semibold`}
                        >
                          {item.year_change_percent.toLocaleString("vi-VN", {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2,
                          })}
                          %
