  ...
  return (
    <div>
      {data?.map((item, index) => {
        return (
          <button
            className={`btnLegend m-1 py-1.5 px-3 rounded-lg border-none cursor-pointer xxs:text-[6px] xs:text-[9px] sm:text-[11px] md:text-[13.5px] lg:text-[11px] xl:text-[13.5px] 2xl:text-[13.5px] ${
              selectedLegend[index] ? "" : "opacity-50"
            }`}
            key={item.name}
      ...
      <button
        className={`btnLegendAll m-1 py-1.5 px-3 rounded-lg border-none cursor-pointer xxs:text-[6px] xs:text-[9px] sm:text-[11px] md:text-[13.5px] lg:text-[11px] xl:text-[13.5px] 2xl:text-[13.5px] ${
          allLegends ? "" : "opacity-50"
        }`}
